...
public class CorsFilterImpl {
    ...
    CorsFilter corsFilter(){
        ...
        corsConfiguration.setAllowedHeaders(List.of("Origin", "Access-Control-Allow-Origin", "Content-Type",
                ...
                "Access-Control-Request-Method", "Access-Control-Request-Headers", "Jwt-Token", "username", "password", "Valid-Days"));
        corsConfiguration.setExposedHeaders(List.of("Origin", "Content-type", "Accept", "Authorization",
                "Access-Control-Allow-Origin", "Access-Control-Allow-Origin", "Access-Control-Allow-Credentials", "Jwt-Token", "username", "password", "Valid-Days"));
